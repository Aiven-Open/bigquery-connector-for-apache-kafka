...
public class BigQuerySinkConfig extends AbstractConfig {
  ...
  public static ConfigDef getConfig() {
    SinceInfo.Builder since = SinceInfo.builder()
    ...
    return new ConfigDef()
            ...
            .define(ExtendedConfigKey.builder(ENABLE_BATCH_CONFIG)
                    ...
                    ExtendedConfigKey.builder(CONVERT_DEBEZIUM_DECIMAL_CONFIG)
                            ...
                            .deprecatedInfo(DeprecatedInfo.builder().since(v2m8)
                                    .description(String.format("Use %s instead.", DEBEZIUM_VARIABLE_SCALE_DECIMAL_HANDLING_MODE_CONFIG))
                            )
                            .documentation("")
                            .since(v2m7).build()
            ).define(
  ...
  /**
   * @return the {@link com.wepay.kafka.connect.bigquery.GcpClientBuilder.KeySource} that dictates how
