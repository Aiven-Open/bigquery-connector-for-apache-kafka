...
public class BigQuerySchemaConverterTest {
  ...
  public void testTopLevelSchema() {
    ...
    assertThrows(
        ConversionConnectException.class, () -> converter.convertSchema(Schema.BOOLEAN_SCHEMA));
  }
  ...
  public void testBoolean() {
    ...
    com.google.cloud.bigquery.Schema bigQueryExpectedSchema =
        com.google.cloud.bigquery.Schema.of(
            com.google.cloud.bigquery.Field.newBuilder(fieldName, LegacySQLTypeName.BOOLEAN)
  ...
  public void testInteger() {
    ...
    com.google.cloud.bigquery.Schema bigQueryExpectedSchema =
        com.google.cloud.bigquery.Schema.of(
            com.google.cloud.bigquery.Field.newBuilder(fieldName, LegacySQLTypeName.INTEGER)
                .setMode(com.google.cloud.bigquery.Field.Mode.REQUIRED)
                .build());

    Schema kafkaConnectTestSchema =
        SchemaBuilder.struct().field(fieldName, Schema.INT8_SCHEMA).build();

    com.google.cloud.bigquery.Schema bigQueryTestSchema =
        createConverter().convertSchema(kafkaConnectTestSchema);
    assertEquals(bigQueryExpectedSchema, bigQueryTestSchema);

    kafkaConnectTestSchema = SchemaBuilder.struct().field(fieldName, Schema.INT16_SCHEMA).build();

    bigQueryTestSchema = createConverter().convertSchema(kafkaConnectTestSchema);
    assertEquals(bigQueryExpectedSchema, bigQueryTestSchema);

    kafkaConnectTestSchema = SchemaBuilder.struct().field(fieldName, Schema.INT32_SCHEMA).build();

    bigQueryTestSchema = createConverter().convertSchema(kafkaConnectTestSchema);
    assertEquals(bigQueryExpectedSchema, bigQueryTestSchema);

    kafkaConnectTestSchema = SchemaBuilder.struct().field(fieldName, Schema.INT64_SCHEMA).build();
  ...
  public void testFloat() {
    ...
    kafkaConnectTestSchema = SchemaBuilder.struct().field(fieldName, Schema.FLOAT64_SCHEMA).build();
  ...
  public void testStruct() { // Struct in a struct in a struct (wrapped in a struct)
    ...
    com.google.cloud.bigquery.Field bigQueryInnerRecord =
        com.google.cloud.bigquery.Field.newBuilder(
                ...
                com.google.cloud.bigquery.Field.newBuilder(
                        innerFieldStringName, LegacySQLTypeName.STRING)
                    .setMode(com.google.cloud.bigquery.Field.Mode.REQUIRED)
                    .build(),
                com.google.cloud.bigquery.Field.newBuilder(
                        innerFieldIntegerName, LegacySQLTypeName.INTEGER)
                    .setMode(com.google.cloud.bigquery.Field.Mode.REQUIRED)
                    .build())
            .setMode(com.google.cloud.bigquery.Field.Mode.REQUIRED)
            .build();
    ...
    com.google.cloud.bigquery.Field bigQueryMiddleRecord =
        com.google.cloud.bigquery.Field.newBuilder(
                ...
                bigQueryInnerRecord,
                com.google.cloud.bigquery.Field.newBuilder(
                        middleFieldArrayName, LegacySQLTypeName.FLOAT)
  ...
  public void testEmptyStruct() { // Empty struct
    com.google.cloud.bigquery.Schema bigQueryTestOuterSchema =
        createConverter().convertSchema(SchemaBuilder.struct().build());
  ...
  public void testEmptyInnerStruct() { // Empty nested struct
    ...
    com.google.cloud.bigquery.Field bigQueryInnerString =
        com.google.cloud.bigquery.Field.newBuilder(innerFieldStringName, LegacySQLTypeName.STRING)
            .setMode(com.google.cloud.bigquery.Field.Mode.REQUIRED)
            .build();

    com.google.cloud.bigquery.Field bigQueryOuterRecord =
        com.google.cloud.bigquery.Field.newBuilder(
                outerFieldStructName, LegacySQLTypeName.RECORD, bigQueryInnerString)
            .setMode(com.google.cloud.bigquery.Field.Mode.REQUIRED)
            .build();
  ...
  public void testMap() {
    ...
    Field floatField =
        Field.newBuilder(keyName, LegacySQLTypeName.FLOAT).setMode(Field.Mode.REQUIRED).build();
    Field stringField =
        Field.newBuilder(valueName, LegacySQLTypeName.STRING).setMode(Field.Mode.REQUIRED).build();

    com.google.cloud.bigquery.Schema bigQueryExpectedSchema =
        com.google.cloud.bigquery.Schema.of(
            com.google.cloud.bigquery.Field.newBuilder(
                    fieldName, LegacySQLTypeName.RECORD, floatField, stringField)
                .setMode(com.google.cloud.bigquery.Field.Mode.REPEATED)
                .build());

    Schema kafkaConnectMapSchema =
        SchemaBuilder.map(Schema.FLOAT32_SCHEMA, Schema.STRING_SCHEMA).build();
    Schema kafkaConnectTestSchema =
        SchemaBuilder.struct().field(fieldName, kafkaConnectMapSchema).build();
  ...
  public void testIntegerArray() {
    ...
    Schema kafkaConnectTestSchema =
        SchemaBuilder.struct().field(fieldName, kafkaConnectArraySchema).build();
  ...
  public void testFieldNameSanitized() {
    ...
    com.google.cloud.bigquery.Schema bigQueryExpectedSchema =
        com.google.cloud.bigquery.Schema.of(
            com.google.cloud.bigquery.Field.newBuilder(
                    FieldNameSanitizer.sanitizeName(fieldName), LegacySQLTypeName.STRING)
                .setMode(com.google.cloud.bigquery.Field.Mode.REPEATED)
                .build());
  ...
  public void testBytes() {
    ...
    com.google.cloud.bigquery.Schema bigQueryExpectedSchema =
        com.google.cloud.bigquery.Schema.of(
            com.google.cloud.bigquery.Field.newBuilder(fieldName, LegacySQLTypeName.BYTES)
                .setMode(com.google.cloud.bigquery.Field.Mode.REQUIRED)
                .build());
  ...
  public void testTimestamp() {
    ...
    com.google.cloud.bigquery.Schema bigQueryExpectedSchema =
        com.google.cloud.bigquery.Schema.of(
            com.google.cloud.bigquery.Field.newBuilder(fieldName, LegacySQLTypeName.TIMESTAMP)
                .setMode(com.google.cloud.bigquery.Field.Mode.REQUIRED)
                .build());

    Schema kafkaConnectTestSchema =
        SchemaBuilder.struct().field(fieldName, Timestamp.SCHEMA).build();
  ...
  public void testBadTimestamp(String name, String schemaName, BigQuerySinkConfig config) {
    ...
    Schema kafkaConnectTestSchema =
        SchemaBuilder.struct().field(fieldName, SchemaBuilder.bool().name(schemaName)).build();

    BigQuerySchemaConverter converter = createConverter(config);
    assertThrows(
        ConversionConnectException.class, () -> converter.convertSchema(kafkaConnectTestSchema));
  }
  ...
  public void testDate() {
    ...
    com.google.cloud.bigquery.Schema bigQueryExpectedSchema =
        com.google.cloud.bigquery.Schema.of(
            com.google.cloud.bigquery.Field.newBuilder(fieldName, LegacySQLTypeName.DATE)
                .setMode(com.google.cloud.bigquery.Field.Mode.REQUIRED)
                .build());

    Schema kafkaConnectTestSchema = SchemaBuilder.struct().field(fieldName, Date.SCHEMA).build();
    ...
    switch (decimalHandlingMode) {
        ...
        FieldList fieldList =
            FieldList.of(
                ...
                Field.newBuilder("value", LegacySQLTypeName.BYTES)
                    .setMode(Field.Mode.REQUIRED)
                    .build());
        bigQueryExpectedSchema =
            com.google.cloud.bigquery.Schema.of(
                com.google.cloud.bigquery.Field.newBuilder(
                        fieldName, LegacySQLTypeName.RECORD, fieldList)
                    .setMode(com.google.cloud.bigquery.Field.Mode.REQUIRED)
                    .build());
        break;
      case NUMERIC:
      ...
      default:
        throw new ConversionConnectException(
            "Unexpected DecimalHandlingMode: " + decimalHandlingMode);
    }
    com.google.cloud.bigquery.Schema bigQueryTestSchema =
        createConverter(config).convertSchema(kafkaConnectTestSchema);
    assertEquals(bigQueryExpectedSchema, bigQueryTestSchema);
  }
  ...
  private static Stream<Arguments> testBadDecimalData() {
    ...
    for (BigQuerySinkConfig.DecimalHandlingMode decimalHandlingMode :
      ...
      arguments.add(
          Arguments.of(
              Decimal.LOGICAL_NAME + " " + config.getDecimalHandlingMode(),
  ...
  public void testDebeziumVariableScaleDecimal(
      BigQuerySinkConfig.DecimalHandlingMode decimalHandlingMode) {
  ...
  public void testNullable() {
    ...
    com.google.cloud.bigquery.Schema bigQueryExpectedSchema =
        com.google.cloud.bigquery.Schema.of(
            com.google.cloud.bigquery.Field.newBuilder(nullableFieldName, LegacySQLTypeName.INTEGER)
                .setMode(com.google.cloud.bigquery.Field.Mode.NULLABLE)
                .build(),
            com.google.cloud.bigquery.Field.newBuilder(requiredFieldName, LegacySQLTypeName.INTEGER)
                .setMode(com.google.cloud.bigquery.Field.Mode.REQUIRED)
                .build());
  ...
  public void testAllFieldsNullable() {
    ...
    Schema kafkaConnectTestSchema =
        SchemaBuilder.struct().field(fieldName, SchemaBuilder.string().required().build()).build();
  ...
  public void testSimpleRecursiveSchemaThrows() {
    ...
    // Construct Avro schema with recursion since we cannot directly construct Connect schema with
    // cycle
    org.apache.avro.Schema recursiveAvroSchema =
        org.apache.avro.SchemaBuilder.record("RecursiveItem")
